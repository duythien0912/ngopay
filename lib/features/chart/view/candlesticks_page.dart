...
import 'package:ngopay/features/chart/models/binance_repository.dart';

import 'package:web_socket_channel/web_socket_channel.dart';

class CandleSticksPage extends ConsumerStatefulWidget {
  const CandleSticksPage({Key? key}) : super(key: key);

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _CandleSticksPageState();
}

class _CandleSticksPageState extends ConsumerState<CandleSticksPage> {
