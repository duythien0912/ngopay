...
import 'package:ngopay/douyin/page/city/page/douyin_friend_page.dart';
import 'package:ngopay/douyin/page/home/page/douyin_home_page.dart';
...
class _DouyinMainPageState extends State<DouyinMainPage>
  ...
  void initState() {
    ...
    _tabs.add(<String, dynamic>{'title': '首页', 'icon': Icons.home, 'page': DouYinHomePage()});

    _tabs.add(<String, dynamic>{
      'title': '朋友',
