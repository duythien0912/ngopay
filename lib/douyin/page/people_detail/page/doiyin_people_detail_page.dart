...
import 'package:ngopay/douyin/widgets/common_sliver_persistent_header_delegate.dart';
import 'package:ngopay/douyin/widgets/custom_bouncing_scroll_physics.dart';
...
class _DouyinPeopleDetailPageState extends State<DouyinPeopleDetailPage>
  ...
  void initState() {
    ...
    _scrollController.addListener(() {
      var offset = _scrollController.positions.elementAt(0).pixels;
      setState(() {
        appAlpha = offset / 200;
  ...
  Widget _buildScaffoldBody() {
    ...
    return NestedScrollView(
      ...
      body: const TabBarView(
        ...
        children: <Widget>[
          TabViewItem(PageStorageKey<dynamic>('Tab1')),
          TabViewItem(PageStorageKey<dynamic>('Tab2')),
        ],
      ),
    );
  }
