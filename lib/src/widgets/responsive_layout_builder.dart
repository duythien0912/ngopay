...
import 'package:ngopay/src/layout/layout.dart';
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= NgopayBreakpoints.small) {
          return small(context, child);
        } else if (constraints.maxWidth <= NgopayBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        } else if (constraints.maxWidth <= NgopayBreakpoints.large) {
